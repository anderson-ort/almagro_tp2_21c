...
## Criterios de evaluacion (total 10 puntos)

| Criterio | Puntaje |
|----------|---------|
| Login y JWT funcionan | 1.5 |
| GET /random consume API externa con async/await | 2.0 |
| POST /favorites guarda correctamente en json | 1.5 |
| GET /favorites lista favoritos del usuario | 1.5 |
| DELETE /favorites/:id elimina favorito | 1.5 |
| Manejo de errores y codigos HTTP | 1.0 |
| Estructura y calidad de codigo | 1.0 |
